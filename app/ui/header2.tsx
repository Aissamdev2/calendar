      ...
      <div className="relative" ref={dropdownRef} >
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-64 bg-[#ffffffe7] text-black rounded-lg shadow-lg">
            ...
            {/* Options */}
            <ul className="py-2 z-40 border-b border-gray-300">
              <li className="px-4 py-2 hover:bg-gray-200 transition-[background-color] cursor-pointer">Settings</li>
              <li className="px-4 py-2 hover:bg-gray-200 transition-[background-color] cursor-pointer">Account</li>
              <li className="px-4 py-2 hover:bg-gray-200 transition-[background-color] cursor-pointer">Help</li>
            </ul>
